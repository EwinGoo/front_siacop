...
export const ROLE_PERMISSIONS: Record<RoleValue, Permission[]> = {
  [APP_ROLES.ADMINISTRADOR]: [
    ...
    PERMISSIONS.VACACION.VIEW,
    PERMISSIONS.GUARDIA_SEGURIDAD.VIEW,
    PERMISSIONS.GUARDIA_SEGURIDAD.MANAGE,
    PERMISSIONS.PLANILLA_ASISTENCIA.VIEW,
    PERMISSIONS.PLANILLA_ASISTENCIA.IMPORT,
    PERMISSIONS.PLANILLA_ASISTENCIA.CREATE_PROCESS,
    PERMISSIONS.PLANILLA_ASISTENCIA.EXECUTE_PROCESS,
...
export const canManageComisiones = (userRoles: string[]): boolean => {
  return userRoles.some(
    (role) => role === APP_ROLES.ADMINISTRADOR || role === APP_ROLES.CONTROL_PERSONAL
  )
}
