...
import {DECLARATORIA_URL, deleteDeclaratoriaComision} from '../../core/_requests'
...
const ActionsCell: FC<Props> = ({id, estado}) => {
  ...
  const deleteItem = useMutation(() => deleteDeclaratoriaComision(id), {
    onSuccess: () => {
      queryClient.invalidateQueries([`${QUERIES.COMISIONES_LIST}-${query}`])
    ...
    <>
      ...
      >
        ...
        <div className='menu-item px-3'>
          <a href={DECLARATORIA_URL + '/reporte/' + id} className='menu-link px-3' target='_blank'>
