          ...
          {options.map((option) => (
            <div key={option.id} className='col-md-6'>
              <div
                ...
                onClick={() => onTipoSeleccionado(option.tipo as 'TRANSPORTE' | 'COMISIÓN')}
              >
